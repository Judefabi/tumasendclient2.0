...
const ChatScreen = ({navigation, route}) => {
  useEffect(() => {
    navigation.setOptions({
      title: route.params.courier.name
        .split(' ')
...
//filter messages to get the courier's messages ONLY then get the last message the courier sent thereafter get the id for the last message and pass it to the update functionality once the user loads the chat screen to show that the user has read that chat
